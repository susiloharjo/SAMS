...
interface DepartmentAddEditModalProps {
  show: boolean;
  onClose: () => void;
...
export function DepartmentAddEditModal({ show, onClose, onSave, department }: DepartmentAddEditModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">{department ? 'Edit' : 'Add'} Department</h2>
